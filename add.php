...
//    draw_header(msg('area_add_new_file'), $last_message);
    view_header(msg('area_add_new_file'), $last_message);
...
//    display_smarty_template('add.tpl');
    ...
    $view->setData([
        ...
        'avail_users'       => $users_array,
        'avail_depts'       => $departments_array,
        'cats_array'        => $cats_array,
        'dept_perms_array'  => $dept_perms_array,
        'udf_add_form'      => udf_add_file_form(),
...
// REMOVED: Only used one, merged into 'add' template
