...
<code>Common toBePublished</code><br />
        ...
        <div class="buttons">
            ...
            -->
            <button class="positive" type="submit" name="submit" value="commentAuthorize"><?= e::h(msg('button_authorize')) ?></button>
            <button class="negative" type="submit" name="submit" value="commentReject"><?= e::h(msg('button_reject')) ?></button>
        </div>
        <input type="hidden" name="mode" value="" /><!-- $lmode not defined -->
