...
<code>Common deleteview</code><br />
        ...
        <div class="buttons">
            ...
            -->
            <button class="positive" type="submit" name="submit" value="Undelete"><?= e::h(msg('button_undelete')) ?></button>
            <button class="negative" type="submit" name="submit" value="Delete file(s)"><?= e::h(msg('button_delete_files')) ?></button>
        </div>
        <input type="hidden" name="mode" value="<?= e::h($lmode) ?>" />
